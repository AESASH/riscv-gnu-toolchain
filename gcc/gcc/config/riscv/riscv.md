...
(define_insn "riscv_kvcu_kmemstr"
  [(unspec_volatile [(match_operand:P 0 "register_operand" "=r")
                    (match_operand:P 1 "register_operand" "r")
                    (match_operand:SI 2 "register_operand" "r")]
                   UNSPECV_KMEMSTR)]
...
(define_insn "riscv_kvcu_csrw_mvsize"
  [(unspec_volatile [(match_operand:SI 0 "register_operand" "r")]
                   UNSPECV_CSRW_MVSIZE)]
  ""
  "csrw\tMVSIZE,%0")

(define_insn "riscv_kvcu_kaddv"
  [(unspec_volatile [(match_operand:P 0 "register_operand" "=r")
                    (match_operand:P 1 "register_operand" "r")
                    (match_operand:P 2 "register_operand" "r")]
                   UNSPECV_KADDV)]
...
(define_expand "riscv_kvcu_kaddv_complete"
  [(match_operand:P 0 "register_operand")    ;; result pointer
   (match_operand:P 1 "register_operand")    ;; srcA pointer
   (match_operand:P 2 "register_operand")    ;; srcB pointer
   (match_operand:SI 3 "register_operand")]  ;; size
  ""
  {
    emit_insn (gen_riscv_kvcu_kmemld (operands[1], operands[1], operands[3]));
    emit_insn (gen_riscv_kvcu_kmemld (operands[2], operands[2], operands[3]));
    emit_insn (gen_riscv_kvcu_csrw_mvsize (operands[3]));
    emit_insn (gen_riscv_kvcu_kaddv (operands[0], operands[1], operands[2]));
    emit_insn (gen_riscv_kvcu_kmemstr (operands[0], operands[0], operands[3]));
    DONE;
  })
